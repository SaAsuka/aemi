...
import { bulkUpdateAgencyApplicationStatus, bulkDeleteAgencyApplications } from "@/lib/actions/agency-application"
...
export function AgencyBulkActionsBar({
  selectedIds,
  onClear,
}: {
  selectedIds: string[]
  ...
  function handleBulkStatusChange() {
    ...
    startTransition(async () => {
      await bulkUpdateAgencyApplicationStatus(selectedIds, bulkStatus)
      onClear()
      setBulkStatus("")
    })
  }
  ...
  function handleBulkDelete() {
    ...
    startTransition(async () => {
      await bulkDeleteAgencyApplications(selectedIds)
      onClear()
    })
  }
