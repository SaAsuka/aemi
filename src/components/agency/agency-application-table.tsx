...
import { AgencyApplicationStatusSelect } from "@/components/agency/agency-application-status-select"
import { AgencyApplicationRowActions } from "@/components/agency/agency-application-row-actions"
import { AgencyBulkActionsBar } from "@/components/agency/agency-bulk-actions-bar"
...
export function AgencyApplicationTable({
  applications,
  totalCount,
}: {
  applications: AppRow[]
            ...
            applications.map((app) => (
              <TableRow key={app.id} className={selectedIds.has(app.id) ? "bg-primary/5" : ""}>
                ...
                <TableCell className="truncate px-2 py-1.5">
                  <Link
                    href={`/agency/talents/${app.talent.id}`}
