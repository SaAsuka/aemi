...
import { createAgencyApplication } from "@/lib/actions/agency-application"
...
export function AgencyNewApplicationDialog({
  talents,
  jobs,
}: {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      const result = await createAgencyApplication(formData)
      if (result.error) {
